  ...
  function RecursiveTriverse(thecasper, newurl, stream) {
      ...
      thecasper.thenOpen(newurl, function () {
          ...
          for(var i=0; i < query.length; i++) {
            tweetsString = query[i].replace(/((bit\.ly|youtu\.be|pic\.twitter\.com|t\.co|lnkd\.in|tcrn\.ch|amp\.twimg\.com|twitter\.com|donaldjtrump\.com|facebook\.com|hrc\.io)\S*)\b/g, "");
